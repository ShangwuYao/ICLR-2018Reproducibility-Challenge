...
# zero_list = ['decoder.weight', 'rnn.weight_hh_l1', 'rnn.weight_ih_l1', 'rnn.weight_hh_l0', 'rnn.weight_ih_l0']
...
def train():
    ...
    for batch, i in enumerate(range(0, train_data.size(0) - 1, args.bptt)):
        ...
        if batch % args.log_interval == 0 and batch > 0:
            ...
            weight_l0 = torch.cat((model.rnn.weight_ih_l0, model.rnn.weight_hh_l0), 1)
            weight_l1 = torch.cat((model.rnn.weight_ih_l1, model.rnn.weight_hh_l1), 1)
